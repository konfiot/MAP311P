...
\section{Une borne théorique inférieure}
	\begin{enumerate}
		...
		\item
			...
			\draw[color=uququq] (-0.4117690554175289,0.04826240501858345) node {$E$};
			\draw [fill=uququq] (0.43588989435406733,0.) circle (1.5pt);
			\draw[color=uququq] (0.4585375073878903,0.04826240501858345) node {$F$};
			\draw[color=qqttff] (-0.04046065700054505,1.0916222032853118) node {$S_p$};
			\draw[color=ffqqqq] (0.01666371198668324,0.49013620041979045) node {$S_b$};
			\end{scriptsize}
			\end{tikzpicture}
			\end{figure}
